...
namespace Simple.OData.Client
{
    public interface IRequestWriter
    {
        ...
        Task<ODataRequest> CreateInsertRequestAsync(string collection, string commandText, IDictionary<string, object> entryData, IList<string> includedProperties, bool resultRequired);
